...
**Способ 1 — через Copilot (без второго аккаунта, нужен платный Copilot Pro/Business):**
...
**Способ 2 — через коллаборатора (нужен второй GitHub-аккаунт или друг):**

1. [Форкни это репо](../../fork) себе
2. В форке перейди **Settings → Collaborators → Add people** → добавь второй аккаунт
3. Открой любой файл → карандашик ✏️ → добавь пробел → **Commit changes...** → **"Create a new branch..."** → **Propose changes**
4. Нажми **Create pull request**
5. В правой панели PR → **Reviewers** → выбери добавленного коллаборатора
6. Нажми **Merge pull request** → **Confirm merge** (не жди ревью)
